...
int write_number(char c, char buffer[], int flags, int width, int precision, int size);
...
/*Funtion to print string in rot 13 */
int print_rot13string(va_list types, char buffer[], int flags, int width, int precision, int size);

/* Funtion to handle other specifiers */
...
/* Funtion to print non printable characters */
